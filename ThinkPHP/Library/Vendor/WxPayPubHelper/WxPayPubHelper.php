...
class Common_util_pub
{
	...
	public $JS_API_CALL_URL = 'http://www.yujia.com/index.php/Home/Weixin/jsApiCall';
	
	//=======【异步通知url设置】===================================
	//异步通知url，商户根据实际开发过程设定
	public $NOTIFY_URL = 'http://www.yujia.com/index.php/home/Weixin/notify';
	...
	function __construct($config) {
		...
		if(isset($config['appid'])){
			...
			//=======【基本信息设置】=====================================
			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
			$this->APPID = 'wx021b3116df44b02a';
			//受理商ID，身份标识
			$this->MCHID = '1251443901';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
			$this->KEY = 'Gkk522004yujiacom20160414lianapp';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
			$this->APPSECRET = 'e2442184298668652dff3956f4c9a9d4 ';		
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径
	...
	function postXmlSSLCurl($xml,$url,$second=30)
	{
		...
		curl_setopt($ch,CURLOPT_SSLCERT, '/alidata/www/default/lib/Library/Vendor/WxPayPubHelper/cacert/apiclient_cert.pem');
		//默认格式为PEM，可以注释
		curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
		// curl_setopt($ch,CURLOPT_SSLKEY, $this->SSLKEY_PATH);
		curl_setopt($ch,CURLOPT_SSLKEY, '/alidata/www/default/lib/Library/Vendor/WxPayPubHelper/cacert/apiclient_key.pem');

		// curl_setopt($ch, CURLOPT_CAINFO, $this->SSLCA_PATH);
		curl_setopt($ch, CURLOPT_CAINFO, '/alidata/www/default/lib/Library/Vendor/WxPayPubHelper/cacert/rootca.pem');
		//post提交方式
		curl_setopt($ch,CURLOPT_POST, true);
		curl_setopt($ch,CURLOPT_POSTFIELDS,$xml);
		$data = curl_exec($ch);
...
class Wxpay_server_pub extends Common_util_pub 
{
	...
	function updateDate($xml){
		$x_data = $this->xmlToArray($xml);
		return $x_data;
	}
