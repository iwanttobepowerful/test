...
class StatisticsController extends Controller {
    ...
    public function makeExcel1()
    {
        ...
        $objActSheet->getStyle( 'C1')->getFont()->setName('SimHei' )->setBold(true);
        $mytitle = '';
        $mytitle .= '作废编号';
    ...
    private function fillDepartment($begin_time, $end_time, $objPHPExcel, $ch)   //$ch是数字
    {
        ...
        $objActSheet->getStyle( 'B1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'C1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'D1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'E1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'F1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'G1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'H1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'I1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'J1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'K1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'L1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'M1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'N1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'O1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'P1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'Q1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'R1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'S1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'T1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'U1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'V1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'W1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'X1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'Y1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'Z1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'AA1')->getFont()->setName('SimHei' )->setBold(true);
        $objActSheet->getStyle( 'AB1')->getFont()->setName('SimHei' )->setBold(true);
